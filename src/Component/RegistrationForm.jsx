         ...
         <div className='w-fit flex gap-5 lg:w-full md:w-full justify-center'>
            ...
            <div className='w-1/2 shadow-white shadow-sm p-5 grid justify-center'>
               ...
               <form>
                  ...
                  <input className='py-1 px-2 block text-white w-[50vh] lg:w-[400px] rounded-full bg-transparent border-2 mb-2' type="password" name="password" placeholder='Enter your password' />
            ...
            <div className='w-1/2 lg:w-1/2 shadow-white shadow-sm p-5 grid justify-center'>
               ...
               <form>
                  ...
                  <input className='py-1 px-2 block text-white w-[50vh] lg:w-[400px] rounded-full bg-transparent border-2 mb-2' type="email" name="email" placeholder='Enter your email' />
